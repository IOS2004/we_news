...
/**
 * Maps NewsAPI categories to app categories
 */
const mapCategory = (apiCategory: string, sourceName: string): string => {
  // Map based on source name for better categorization
